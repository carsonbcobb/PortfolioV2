  ...
  const validateAndBuild = () => {
    ...
    const articleSchema = {
      ...
      author: {
        ...
        description: 'Full-store Shopify operator with 6+ years across DTC brands. Across 50+ stores worked on, clients have seen a combined $10M+ in additional revenue.',
